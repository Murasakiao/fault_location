...
def calculate_3_phase_fault_voltage(system_data, bus_num):
    per_unit_values = []
    # assign base values
    Vf = 1
...
def calculate_SLG_fault_voltage(system_data, bus_num):
    per_unit_values = []
    # assign base values
    Vf = 1
    base_mva = system_data[5]
...
def calculate_LL_fault_voltage(system_data, bus_num):
    per_unit_values = []
    # assign base values
    Vf = 1
    base_mva = system_data[5]
...
def calculate_DLG_fault_voltage(system_data, bus_num):
    per_unit_values = []
    # assign base values
    Vf = 1
    base_mva = system_data[5]
...
fault_voltage = calculate_LL_fault_voltage(system_data, 1)
print(fault_voltage)
