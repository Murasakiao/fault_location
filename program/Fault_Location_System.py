...
def main():
    ...
    fault_current_button = tk.Button(root, text="Fault Current", bg='#2b2b2b', fg='white', command=calculate_fault_current)
    fault_current_button.pack(side='left', padx=(10, 5), pady=(0,150))

    fault_voltage_button = tk.Button(root, text="Fault Voltage", bg='#2b2b2b', fg='white', command=calculate_fault_voltage)
    fault_voltage_button.pack(side='left', padx=(0, 5), pady=(0,150))

    bus_finder_button = tk.Button(root, text="Bus Finder", bg='#2b2b2b', fg='white', command=calculate_bus_finder)
    bus_finder_button.pack(side='left', padx=(0, 5), pady=(0,150))
    ...
    def get_values():
        global entry
        entry = int(entry1.get())
    bus_num = tk.Button(root, text="set", bg='#2b2b2b', fg='white', command=get_values)
    bus_num.pack(side='left', padx=(0, 5), pady=(0,150))
    entry1 = tk.Entry(root, width=8)
    entry1.pack(side='left', padx=(0, 10), pady=(0,155))
    ...
    radio_button1.place(x=447, y=80)
    radio_button2.place(x=447, y=108)
    radio_button3.place(x=447, y=136)
    radio_button4.place(x=447, y=164)
